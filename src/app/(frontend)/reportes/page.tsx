      ...
      <body>
        <table>
          ...
          <tr>
            ...
            <td class="table-header">Fecha Solicitud</td>
          ...
          ${reporte.solicitudes.map((s, index) => {
            ...
            const fechaSol = s.fechaSolicitud ? formatDateShort(s.fechaSolicitud) : '-'
            
            return `
              <tr class="${rowClass}">
                <td class="table-cell">${formatDateShort(s.createdAt)}</td>
                <td class="table-cell">${fechaSol}</td>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        {loading ? (
          ...
          <>
            {/* Info del Período */}
            <div className="bg-linear-to-r from-primary to-neutral text-white rounded-xl shadow p-6 mb-6">
