            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                  ...
                  {(() => {
                    const telefonoLimpio = selectedSolicitud.telefono.replace(/[^0-9]/g, '')
                    const esCelular = telefonoLimpio.length >= 10
                    return (
                      <div className={esCelular ? "grid grid-cols-2 gap-2" : ""}>
                        {esCelular && (
                          <a
                            href={`https://wa.me/549${telefonoLimpio}`}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center justify-center gap-2 px-4 py-2.5 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors font-medium text-sm"
                          >
                        ...
                        <a
                          ...
                          className={`flex items-center justify-center gap-2 px-4 py-2.5 bg-primary text-white rounded-lg hover:bg-neutral transition-colors font-medium text-sm ${!esCelular ? 'w-full' : ''}`}
                        >
